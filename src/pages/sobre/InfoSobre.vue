        ...
        <div class="main-content">
            <div class="main-container" :style="{ flexDirection: layoutDirection }">
                <div class="image-container">
                    <img src="/src/assets/images/first-image-page-sobre.png" alt="Sobre a FireBeauty"
                        class="main-image">
                </div>
            ...
            <div class="middle-container" ref="middleContainer">
                <img src="/src/assets/images/second-image-page-sobre.png" alt="Comunidade FireBeauty"
